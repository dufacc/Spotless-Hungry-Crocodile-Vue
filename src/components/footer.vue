    ...
    <div class="footer-max-width thq-section-max-width">
      <div class="footer-content">
        ...
        <div class="footer-links">
          <div class="footer-column1">
            <div class="footer-footer-links1"></div>
          </div>
          <div class="footer-column2">
            <div class="footer-footer-links2"></div>
          </div>
      ...
      <div class="footer-credits">
        ...
        <div class="footer-row">
          ...
          <div class="footer-footer-links3"></div>
        </div>
      </div>
    </div>
  </footer>
...
export default {
  ...
  props: {
    ...
    content3: {
      type: String,
      default: 'Join our community to engage with other meme coin enthusiasts.',
    },
    action1: {
      type: String,
      default: 'Subscribe',
    ...
    content2: {
      type: String,
      default: 'Stay updated with our latest news and announcements.',
    },
  },
}
</script>
