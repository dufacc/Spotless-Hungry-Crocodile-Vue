    ...
    <header data-thq="thq-navbar" class="navbar-navbar-interactive">
      ...
      <div data-thq="thq-navbar-nav" class="navbar-desktop-menu">
        ...
        <div class="navbar-buttons1">
          <button class="navbar-action11 thq-button-filled thq-button-animated">
            <a
              href="https://app.uniswap.org/explore/tokens/optimism/0x62fc0b85b64959b16d16c69d9075b5acd0ad034f"
              target="_blank"
              rel="noreferrer noopener"
              class="navbar-link thq-body-small"
            >
              BUY $GATES95
            </a>
          </button>
...
export default {
  ...
  props: {
    ...
    link4: {
      type: String,
      default: 'History of Microsoft',
    },
    action2: {
      type: String,
      default: 'Discover the history of Microsoft',
    },
    logoSrc: {
      type: String,
      default:
    ...
    action1: {
      type: String,
      default: 'Learn more about the meme coin',
    },
    link3: {
      type: String,
