    ...
    <div class="pricing-max-width thq-section-max-width">
      ...
      <div class="pricing-tabs">
        <button
          ...
          v-if="isMonthly"
          class="pricing-button10 thq-button-filled thq-button-animated"
        >
        ...
        <button
          ...
          v-if="!isMonthly"
          class="pricing-button12 thq-button-filled thq-button-animated"
        >
      ...
      <div v-if="isMonthly" class="pricing-container1">
        ...
        <div class="pricing-column2 thq-card">
          ...
          <button class="pricing-button15 thq-button-filled thq-button-animated">
        ...
        <div class="pricing-column3 thq-card">
          ...
          <button class="pricing-button16 thq-button-filled thq-button-animated">
      ...
      <div v-if="!isMonthly" class="pricing-container2">
        ...
        <div class="pricing-column5 thq-card">
          ...
          <button class="pricing-button18 thq-button-filled thq-button-animated">
        ...
        <div class="pricing-column6 thq-card">
          ...
          <button class="pricing-button19 thq-button-filled thq-button-animated">
...
export default {
  ...
  props: {
    plan1Feature3: {
      type: String,
      default: 'Limited edition Bill Gates dance emoji pack',
    },
    plan3Yearly1: {
      type: String,
    ...
    plan3Action: {
      type: String,
      default: 'Join the Party',
    },
    plan2Feature3: {
      type: String,
      default: 'Bill Gates dance-off competition entry',
    },
    plan3Price1: {
      type: String,
      default: '$499/yr',
    ...
    plan3Feature3: {
      type: String,
      default: 'VIP access to Bill Gates tribute concert',
    },
    plan2Feature21: {
      type: String,
      default: 'Feature text goes here',
    ...
    plan2Feature2: {
      type: String,
      default: 'Live Q&A session with Bill Gates impersonator',
    },
    heading1: {
      type: String,
    ...
    plan3Feature2: {
      type: String,
      default: 'Personalized video message from a Bill Gates lookalike',
    },
    plan3Feature31: {
      type: String,
      default: 'Feature text goes here',
    ...
    plan3Feature1: {
      type: String,
      default: 'All features from Plan 1 and Plan 2',
    },
    plan11: {
      type: String,
      default: 'Basic plan',
    ...
    plan2Feature1: {
      type: String,
      default: 'All features from Plan 1',
    },
    plan3Feature11: {
      type: String,
      default: 'Feature text goes here',
    ...
    plan1Feature1: {
      type: String,
      default: 'Access to exclusive Bill Gates memes',
    },
    plan3Feature21: {
      type: String,
      default: 'Feature text goes here',
    ...
    plan1Feature2: {
      type: String,
      default: 'Early access to dance like Bill Gates tutorial videos',
    },
    plan2Feature41: {
      type: String,
      default: 'Feature text goes here',
