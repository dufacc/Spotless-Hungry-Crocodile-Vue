...
export default {
  ...
  props: {
    content3: {
      type: String,
      default: 'Follow us on social media for the latest updates and memes!',
    },
    content5: {
      type: String,
      default: 'Stay tuned for more memes and updates!',
    },
    content1: {
      type: String,
      default:
        'Have a question or just want to say hi? Drop us a message below!',
    },
    email1: {
      type: String,
      default: 'contact@memecoin.com',
    },
    content2: {
      type: String,
    ...
    content4: {
      type: String,
      default:
        "Join our community and let's dance together when the coin goes to the moon!",
    },
    phone1: {
      type: String,
    ...
    address1: {
      type: String,
      default: '123 Meme Coin Street, Crypto City',
    },
    heading1: {
      type: String,
      default: 'Contact Us',
